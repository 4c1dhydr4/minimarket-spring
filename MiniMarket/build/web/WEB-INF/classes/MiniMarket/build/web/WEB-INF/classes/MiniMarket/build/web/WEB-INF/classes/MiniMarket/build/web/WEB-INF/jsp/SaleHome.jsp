                    ...
                    <tbody>
                        <c:forEach items = "${Datos}" var = "Dato">
                            <tr>
                                ...
                                <td>
                                    <a type="button" class="btn btn-primary btn-sm" href = "<c:url value = "SaleDetail.htm?idSale=${Dato.idSale}" />"> <span class = "glyphicon glyphicon-plus" aria-hidden = "true"> </span> Detalle </a>
                                    <a type="button" class="btn btn-warning btn-sm" href = "<c:url value = "SaleEdit.htm?idSale=${Dato.idSale}" />"> <span class = "glyphicon glyphicon-pencil" aria-hidden = "true"> </span> Editar </a>
                                    <button type="button" class="btn btn-danger btn-sm" id="deleteBtn${Dato.SaleCode}" href = "#"> <span class = "glyphicon glyphicon-trash" aria-hidden = "true"> </span> Eliminar </button> 
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
        ...
        <script>
            ...
            <c:forEach items = "${Datos}" var = "Dato">
                $('#deleteBtn${Dato.SaleCode}').click(function () {
                    var answer = confirm('¿Desea eliminar la venta ${Dato.SaleCode}?');
                    if (!answer) {
